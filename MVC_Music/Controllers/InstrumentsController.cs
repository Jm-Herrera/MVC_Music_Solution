    ...
    public class InstrumentsController : CustomControllers.ElephantController
    {
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            if (User.IsInRole("Staff"))
            {
                ...
                {
                    ModelState.AddModelError("", "As a part of Staff, you cannot edit this musician if you did not create it into the system");
        ...
        public async Task<IActionResult> InsertFromExcel(IFormFile theExcel)
        {
            ...
            List<Instrument> instNames = new List<Instrument>();
            ...
            _context.Instruments.AddRange(instNames);
            _context.SaveChanges();
            return RedirectToAction("Index", "Lookups", new { Tab = "Instruments-Tab" });
        }
